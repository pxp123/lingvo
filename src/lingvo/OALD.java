...
public class OALD {
	...
	String getStatictic() {
		return title + "\nВсего прочитано слов/выбрано: " + cntRead + "/"
				+ cntSel + " err/war: " + cntErr + "/" + cntWar
				+ " Пропущено слов: " + cntSkip + " Скопировано слов: "
				+ cntSel;
	}
	 ...
	 * д.б. строка <OALD id="xmlDoc" isroot="1"> 2. Заменить p: на пусто
	 * 
	 * @param xml
	 * @return
	 */
	...
	/**
	 * Процесс обработки:
	 * 1)Для слов с несколькими pos (entry31758.xml rose) 2)Для слов с 1 pos
	 * entry00004.xml A2
	 * 0.<entry> 0.<entry>
	 ...
	 * 1.
	 * <p-g>
	 * то что относится к одному значению по pos 2. <n-g> 2. <z> - pos 3. тоже
	 * что и в случае 1) 2.<n-g> 3.<alt> - альтернативное слово 3.<ngnum> -
	 * номер начения 3.<span> - группа 4.<d> - значение 5.<span> - пример
	 * 
	 ...
	 * the Beatitudes
	 * </p:alt>
	 * - 3. альтер. значение (03119 beatitude)
	 * <p:ngnum>
	 * 1
	 * </p:ngnum>
	 * - 3. number
	 ...
	 * - 2.[] список значений слова <span class="label">
	 * <p:z>
	 * [
	 * <p:gr>
	 * <p:zgct>
